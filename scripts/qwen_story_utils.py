...
DEFAULT_NEGATIVE_PROMPT = (
    ...
    "messy composition, overlapping panels, unclear panel borders, broken gutters, "
    "confusing layout, extra panels, horizontal comic strip, freeform collage, "
    "irregular panel layout, open book, book spine, center crease, page fold, "
    "curved pages, bound book, visible book edges, text, watermark, logo"
)
...
def page_layout_phrase(num_panels: int, layout: str) -> str:
    ...
    return (
        f"{panel_word} flat multi-panel storyboard layout, {panel_shape}, "
        f"clear gutters, {flow}, single flat canvas"
    )
